...
const disabled = '<:wrong:1199966197404409886>'
const enabled = '<:stick:1199966253482266624>'
      ...
      if(data){
        return message.reply({embeds: [new MessageEmbed()
          ...
          .addFields([
            ...
            {
              name: '__**Channels**__',
              value: `**Total: ** ${channels.size}\n**Channels: **${channels.filter(channel => channel.type === 'GUILD_TEXT').size} Text Channel | ${channels.filter(channel => channel.type === 'GUILD_VOICE').size} Voice Channel`
            },
            {
